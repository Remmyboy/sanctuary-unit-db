...
export const MODS: Mod[] = [
  ...
  },
  {
    ...
    points: [
      'Everything under construction as tiles, alloy on one side and energy on the other, hungriest first — click to select the builders, right-click to pause them.',
  ...
  },
  {
    ...
    points: [
      ...
      'Resizable and lockable, and hides itself completely when nothing is idle.',
    ],
  },
  {
    id: 'BuildHotkeys',
